    ...
    return (
        <div>
            <div className="flex gap-10 justify-center">
                {[1, 2, 3].map(index => (
                    <div key={index} className={`relative flex flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md transition-all ${expandedIndex === index ? 'w-full h-96' : 'w-80 hover:scale-125'}`}>
