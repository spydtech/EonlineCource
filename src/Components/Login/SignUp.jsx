...
// import SingUp1 from "../../assets/singup1.svg";
...
//               style={{ backgroundImage: `url(${SingUp1})` }}
//             ></div>
//           </div>
...
//             <h1 className=" font-bold text-4xl dark:text-gray-400 text-center cursor-default">
//               Sign Up
//             </h1>
//               <form
//                 onSubmit={handleSubmit}
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
      ...
      <div className="flex-1 bg-indigo-100 text-center hidden lg:flex">
        ...
        <div id="back-div" className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
        <div>
             <img src={IMG} className="w-32 mx-auto" alt="Logo" />
            </div>
          {/* form part */}
          <div className="  bg-white ">
            <h1 className=" pb-6 font-bold text-3xl dark:text-gray-400 text-center cursor-default">
              Sign Up
            </h1>
            <form 
            onSubmit={handleSubmit}
