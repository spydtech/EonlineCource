...
function SignUp() {
  ...
  const handleSubmit=(event)=>{
    ...
    if(error.isError){
      alert("Form data is invalid, correct all details then submit")
    ...
    signUp(data).then((resp)=>{
      console.log(resp)
      console.log("success")
      alert("User is registred successfully"+resp.id)
      setData({
        username:"",
        email:'',
        password:''
  ...
  //   try {
  //     const response = await axios.post('http://localhost:3465/api/v1/user/signup', {
  //       username: username,
  //       email: email,
  //       password: password
  //     });
